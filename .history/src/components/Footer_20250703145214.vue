      ...
      <div class="footer-content">
        <div class="footer-section" v-for="(section, i) in sections" :key="i">
          <button class="footer-toggle" @click="toggleSection(i)">
            <span>
              <router-link v-if="section.type === 'about'" to="/about" style="color:inherit;font-weight:600;text-decoration:none;">{{ section.title }}</router-link>
...
const sections = [
  ...
  },
  {
    ...
    links: [
      ...
      { text: 'Tours', to: '/tours' },
      { text: 'FAQs', to: '/faqs' },
      { text: 'Things to Do in Istanbul', to: '/things-to-do-in-istanbul' },
      { text: 'Plan & Save', to: '/plan-save' }
    ]
  },
  {
    title: 'Support',
