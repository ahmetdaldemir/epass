        ...
        <template v-if="currentStep === 1">
          ...
          <div class="form-group phone-row">
            ...
            <div class="phone-input-group">
              <select v-model="country" class="country-code-select">
                <option value="Turkey (+90)">🇹🇷 +90</option>
                <option value="United States (+1)">🇺🇸 +1</option>
                <option value="Germany (+49)">🇩🇪 +49</option>
                <option value="France (+33)">🇫🇷 +33</option>
              </select>
              <input
                v-model="phone"
                type="tel"
                required
                class="phone-input"
                :placeholder="country === 'Turkey (+90)' ? '5xx xxx xx xx' : country === 'United States (+1)' ? 'xxx xxx xxxx' : country === 'Germany (+49)' ? '1xx xxxxxxx' : 'xx xx xx xx'"
              />
            </div>
          </div>
