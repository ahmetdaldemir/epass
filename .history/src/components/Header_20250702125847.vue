      ...
      <div class="header">
        <div class="logo">
          <router-link class="d-block d-none-xs" to="/">
            ...
            <span class="header-tursab">We will make your visits memorable!</span>
          </router-link>
        </div>
          ...
          <div class="header-right">
            <div class="top-links">
              <ul>
                ...
                <li class="btn btn-red buy-btn menu-btn">
                  <router-link class="price-btn buy-btn" to="/istanbul-pass">
                    <span>Buy Now</span>
                  </router-link>
                </li>
              </ul>
