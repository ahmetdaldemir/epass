        ...
        <div class="order-summary-panel">
          ...
          <div class="order-summary-product">
            ...
            <div class="order-summary-product-info">
              ...
              <div class="product-detail" v-if="tourDetails.bookingDate"><i class="fas fa-calendar-alt"></i> {{ tourDetails.bookingDate }}</div>
              <div class="product-detail"><i class="fas fa-user"></i> {{ tourDetails.participants }}</div>
              <div class="product-detail" v-if="tourDetails.email"><i class="fas fa-envelope"></i> {{ tourDetails.email }}</div>
...
const name = ref('')
const email = ref(props.tourDetails.email || '')
const cardName = ref('')
...
/* Eski media query'leri ve !important'lı responsive CSS'leri kaldır */

/* Modern ve sade mobil responsive CSS */
