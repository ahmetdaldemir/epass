        ...
        <div class="checkout-modal-summary">
          <div class="summary-card">
            ...
            <div class="summary-tour">
              <img class="summary-img" :src="displayTour.image" alt="Tour image" v-if="displayTour && displayTour.image" />
              <div>
                <div class="tour-name">{{ displayTour.name }}</div>
                <div class="tour-date">{{ displayTour.date }}</div>
                <div class="tour-detail">{{ displayTour.detail }}</div>
              </div>
            </div>
            <div class="summary-info">
              <div v-if="displayTour.person"><i class="fas fa-user"></i> {{ displayTour.person }}</div>
              <div v-if="displayTour.rating"><i class="fas fa-star"></i> {{ displayTour.rating }}</div>
            </div>
...
const displayTour = computed(() => props.tour || dummyTour)
