                ...
                <select v-model="form.countryCode">
                  <option v-for="c in countryCodes" :key="c.code" :value="c.code">
                    <span style="display:inline-flex;align-items:center;gap:4px;">
                      <img :src="c.flagUrl" :alt="c.country" style="width:18px;height:12px;object-fit:cover;vertical-align:middle;" />
                      {{ c.code }}
                    </span>
                  </option>
                </select>
...
const countryCodes = [
  { code: '+90', country: 'TR', flagUrl: 'https://flagsapi.com/TR/flat/32.png' },
  { code: '+1', country: 'US', flagUrl: 'https://flagsapi.com/US/flat/32.png' },
  { code: '+44', country: 'GB', flagUrl: 'https://flagsapi.com/GB/flat/32.png' },
]
