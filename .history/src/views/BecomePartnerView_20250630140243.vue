    ...
    <form class="partner-form" @submit.prevent="submitForm">
      ...
      <section class="form-section">
        ...
        <div class="form-row agreements">
          <label><input type="checkbox" v-model="form.agreeCookies" required /> LimlApp Çerez Politikasını okudum ve kabul ediyorum.
            <br>
            <a href="/docs/cerez-politikasi.pdf" target="_blank" style="color:#3498db;">LimlApp Çerez Politikasını Oku</a>
          </label>
          <label><input type="checkbox" v-model="form.agreeContract" required /> LimlApp E-Ticaret Aracılık Sözleşmesini okudum ve kabul ediyorum.
            <br>
