...
const countryCities = {
  'Türkiye': ['İstanbul', 'Ankara', 'İzmir', 'Antalya', 'Bursa', 'Adana', 'Konya', 'Gaziantep', 'Kayseri', 'Mersin', 'Eskişehir', 'Diyarbakır', 'Samsun', 'Denizli', 'Şanlıurfa', 'Trabzon', 'Erzurum', 'Malatya', 'Sakarya', 'Kocaeli'],
  'Kuzey Kıbrıs': ['Lefkoşa', 'Gazimağusa', 'Girne', 'Güzelyurt', 'İskele', 'Lefke'],
  'Birleşik Arap Emirlikleri': ['Abu Dhabi', 'Dubai', 'Sharjah', 'Ajman', 'Fujairah', 'Ras Al Khaimah', 'Umm Al Quwain'],
  'Karadağ': ['Podgorica', 'Nikšić', 'Herceg Novi', 'Pljevlja', 'Bijelo Polje', 'Bar', 'Cetinje', 'Berane', 'Ulcinj', 'Tivat'],
  'Gürcistan': ['Tiflis', 'Kutaisi', 'Batumi', 'Rustavi', 'Zugdidi', 'Gori', 'Poti', 'Kobuleti', 'Samtredia', 'Senaki']
}
